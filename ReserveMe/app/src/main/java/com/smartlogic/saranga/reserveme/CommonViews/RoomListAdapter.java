...
import com.smartlogic.saranga.reserveme.CustomerViews.ViewHotelActivity;
...
public class RoomListAdapter extends BaseAdapter {
    ...
    public RoomListAdapter(String[] availabilities, String[] capacities, String[] charges, String[] roomNumbers, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final View rowView;
        rowView = inflater.inflate(R.layout.room_list, null);
